<html>
<head>
<title>Welcome to Online DVD Store | Home</title>
		...
		<div class="container">
			<div class="header">
				...
				<ul class="megamenu skyblue">
					...
					<li class="grid"><a class="color2" href="Movies.jsp">Movies</a>
						<div class="megapanel">
					...
					<li class="grid"><a class="color2" href="GamesPage.jsp">Games</a>
					<li class="grid"><a class="color2" href="SongsPage.jsp">Songs</a>
					<li class="grid"><a class="color2" href="SoftwaresPage.jsp">Softwares</a>
			</div>
